 ...
 *   // onError is optional
 *   onError={(error, stack) => {...}}
 *   // Fallback is rendered with props {error, componentStack}
 ...
 *  with it. Create a fallback component to render in its place
 *  (get creative if you'd like, or just render some text!)
 *
 * STRETCH GOAL
 *
