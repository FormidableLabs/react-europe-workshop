...
function v(a) {
  var b = a.alternate;
  if (!b) return (b = t(a)), 3 === b ? r("188") : void 0, 1 === b ? null : a;
  for (var c = a, d = b; ; ) {
    var e = c.return,
...
f(y.prototype, {
  ...
  destructor: function() {
    ...
    for (a = 0; a < w.length; a++) this[w[a]] = null;
  }
});
y.Interface = x;
y.extend = function(a) {
  ...
  scryRenderedDOMComponentsWithClass: function(a, b) {
    return S.findAllInRenderedTree(a, function(a) {
      if (S.isDOMComponent(a)) {
        ...
        var e = c.split(/\s+/);
        Array.isArray(b) ||
          (void 0 === b ? r("11") : void 0, (b = b.split(/\s+/)));
...
function T(a) {
  return function(b, c) {
    ...
    g.persist();
    f(g, c);
    d.phasedRegistrationNames
      ? M.accumulateTwoPhaseDispatches(g)
      : M.accumulateDirectDispatches(g);
...
function U() {
  S.Simulate = {};
  var a = void 0;
  for (a in L.eventNameDispatchConfigs) S.Simulate[a] = T(a);
}
...
function X(a) {
  return function(b, c) {
    ...
    f(d, c);
    S.isDOMComponent(b)
      ? S.simulateNativeEventOnDOMComponent(a, b, d)
      : b.tagName && S.simulateNativeEventOnNode(a, b, d);
  };
}
[]
  .concat(
  ...
  .forEach(function(a) {
    var b =
      0 === a.indexOf("top") ? a.charAt(3).toLowerCase() + a.substr(4) : a;
