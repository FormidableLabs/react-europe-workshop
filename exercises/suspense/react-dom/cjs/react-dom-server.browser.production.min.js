...
var C = "function" === typeof Symbol && Symbol.for,
  aa = C ? Symbol.for("react.call") : 60104,
  ba = C ? Symbol.for("react.return") : 60105,
  ca = C ? Symbol.for("react.portal") : 60106,
  E = C ? Symbol.for("react.fragment") : 60107,
  da = C ? Symbol.for("react.strict_mode") : 60108,
  ea = C ? Symbol.for("react.profile_root") : 60108,
  F = C ? Symbol.for("react.provider") : 60109,
  fa = C ? Symbol.for("react.context") : 60110,
  ha = C ? Symbol.for("react.async_mode") : 60111,
  ia = C ? Symbol.for("react.forward_ref") : 60112,
  ja = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,
  G = {},
  H = {};
function ka(a) {
  if (H.hasOwnProperty(a)) return !0;
  if (G.hasOwnProperty(a)) return !1;
  if (ja.test(a)) return (H[a] = !0);
  G[a] = !0;
  return !1;
}
function la(a, b, d, c) {
...
function ma(a, b, d, c) {
  if (null === b || "undefined" === typeof b || la(a, b, d, c)) return !0;
  if (c) return !1;
  if (null !== d)
    switch (d.type) {
      case 3:
...
var R = t.Children.toArray,
  S = w.thatReturns("");
w.thatReturns("");
var qa = { listing: !0, pre: !0, textarea: !0 };
function T(a) {
...
function wa(a, b) {
  function d(c, k) {
    ...
    if (
      ...
      c = e.getChildContext();
      for (var r in c) r in d ? void 0 : A("108", T(k) || "Unknown", r);
    }
    c && (b = q({}, b, c));
  }
...
var W = (function() {
    function a(b, d) {
      ...
      t.isValidElement(b)
        ? b.type !== E
          ? (b = [b])
          : ((b = b.props.children), (b = t.isValidElement(b) ? [b] : R(b)))
        : (b = R(b));
      this.stack = [
        {
          type: null,
    ...
    a.prototype.render = function(a, d, c) {
      ...
      if ("object" === typeof b && null !== b)
        switch (b.$$typeof) {
          ...
          case fa:
            return (
              (b = R(a.props.children(a.type._currentValue))),
              this.stack.push({
                type: a,
                domNamespace: c,
                children: b,
      ...
      A("130", null == b ? b : typeof b, "");
    };
    a.prototype.renderDOM = function(a, d, c) {
      var b = a.type.toLowerCase();
      c === N.html && O(b);
      U.hasOwnProperty(b) || (ra.test(b) ? void 0 : A("65", b), (U[b] = !0));
      var f = a.props;
      if ("input" === b)
        f = q({ type: void 0 }, f, {
        ...
        if (null == h) {
          ...
          null != l &&
            (null != h ? A("92") : void 0,
            Array.isArray(l) && (1 >= l.length ? void 0 : A("93"), (l = l[0])),
            (h = "" + l));
          null == h && (h = "");
        }
        f = q({}, f, { value: void 0, children: "" + h });
      } else if ("select" === b)
        ...
        if (null != l) {
          ...
          f = q({ selected: void 0, children: void 0 }, f, {
            selected: h,
            children: D
          });
        }
          ...
          if (null != e) {
            ...
            if (m)
              va.hasOwnProperty(r) ||
                ((g = r),
                (g =
                  ka(g) && null != e ? g + "\x3d" + ('"' + M(e) + '"') : ""));
            else {
              m = r;
              g = e;
              e = J.hasOwnProperty(m) ? J[m] : null;
              if ((n = "style" !== m))
                n =
                  null !== e
                    ? 0 === e.type
